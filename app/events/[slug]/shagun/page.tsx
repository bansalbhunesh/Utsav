      ...
      <div className="max-w-2xl mx-auto px-4 -mt-10 relative z-10">
        ...
        <div className="mt-8 text-center space-y-6">
          <div className="inline-flex items-center gap-2 bg-zinc-100 px-4 py-2 rounded-full">
            ...
            <span className="text-xs font-bold text-zinc-600 uppercase tracking-wider">Secure Peer-to-Peer Payment</span>
          </div>
          <p className="text-[10px] text-zinc-400 px-10">
            UTSAV uses direct UPI deep-linking. We do not store your bank details or process your money. 
            The transaction happens securely in your preferred UPI app.
          </p>
        </div>
      </div>
    </main>
